import { getCurrentInstance, version as version$7, toRef, isRef, inject, ref, shallowRef, computed, reactive, isReadonly, useSSRContext, createApp, defineAsyncComponent, nextTick, provide, onErrorCaptured, onServerPrefetch, unref, withCtx, createVNode, defineComponent, h, Suspense, Transition } from 'vue';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_...slug_-54e52642.mjs').then((m) => m.default || m)
  },
  {
    name: "blog",
    path: "/blog",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./index-1ed58f07.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./index-f2a8bd4d.mjs').then((m) => m.default || m)
  },
  {
    name: "job-id",
    path: "/job/:id",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_id_-9fc89357.mjs').then((m) => m.default || m)
  },
  {
    name: "job-create",
    path: "/job/create",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./create-d7ca300e.mjs').then((m) => m.default || m)
  },
  {
    name: "user-profil",
    path: "/user/profil",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./profil-aa97bc66.mjs').then((m) => m.default || m)
  },
  {
    name: "user-signup",
    path: "/user/signup",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./signup-79d5f2ed.mjs').then((m) => m.default || m)
  }
];
...
function useCookie(name2, _opts) {
  ...
  const cookie = ref(cookies[name2] ?? ((_a = opts.default) == null ? void 0 : _a.call(opts)));
  {
    const nuxtApp = useNuxtApp();
...
const layouts = {
  default: () => import('./default-f0759974.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./error-component-8f4c5caa.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./island-renderer-927021bb.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { _export_sfc as _, useCookie as a, useState as b, createError as c, useRoute as d, entry$1 as default, useNuxtApp as e, useRequestEvent as f, useRouter as g, useSupabaseUser as h, useRequestFetch as i, useSupabaseAuthClient as j, defineNuxtRouteMiddleware as k, useSupabaseToken as l, createClient as m, navigateTo as n, useRuntimeConfig as u };
