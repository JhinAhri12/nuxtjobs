...
import { eventHandler, setHeaders, sendRedirect, proxyRequest, defineEventHandler, handleCacheHeaders, createEvent, getRequestHeader, getRequestHeaders, setResponseHeader, assertMethod, readBody, setCookie, getQuery, getCookie, createError, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler } from 'h3';
...
const _runtimeConfig = {"app":{"baseURL":"/","buildAssetsDir":"/_nuxt/","cdnURL":""},"nitro":{"envPrefix":"NUXT_","routeRules":{"/__nuxt_error":{"cache":false},"/_nuxt/**":{"headers":{"cache-control":"public, max-age=2592000, immutable"}}}},"public":{"supabase":{"url":"\"https://yjvlypsnoncvcaxscswc.supabase.co\"","key":"\"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inlqdmx5cHNub25jdmNheHNjc3djIiwicm9sZSI6ImFub24iLCJpYXQiOjE2NzcxNjU2NzQsImV4cCI6MTk5Mjc0MTY3NH0.QUGlnp9Eqw_epRx5g2MLWwACY6MvpE4-5RNmkyD1-CQ\"","client":{},"redirect":false,"cookies":{"name":"sb","lifetime":28800,"domain":"","path":"/","sameSite":"lax"}},"content":{"locales":[],"defaultLocale":"","integrity":1677410287305,"experimental":{"stripQueryParameters":false,"clientDB":false},"api":{"baseURL":"/api/_content"},"navigation":{"fields":[]},"tags":{"p":"prose-p","a":"prose-a","blockquote":"prose-blockquote","code-inline":"prose-code-inline","code":"prose-code","em":"prose-em","h1":"prose-h1","h2":"prose-h2","h3":"prose-h3","h4":"prose-h4","h5":"prose-h5","h6":"prose-h6","hr":"prose-hr","img":"prose-img","ul":"prose-ul","ol":"prose-ol","li":"prose-li","strong":"prose-strong","table":"prose-table","thead":"prose-thead","tbody":"prose-tbody","td":"prose-td","th":"prose-th","tr":"prose-tr"},"highlight":false,"wsUrl":"","documentDriven":false,"host":"","trailingSlash":false,"anchorLinks":{"depth":4,"exclude":[1]}}},"supabase":{"serviceKey":""},"content":{"cacheVersion":2,"cacheIntegrity":"kc4UzpZUjI","transformers":[],"base":"","api":{"baseURL":"/api/_content"},"watch":{"ws":{"port":{"port":4000,"portRange":[4000,4040]},"hostname":"localhost","showURL":false}},"sources":{},"ignores":["\\.","-"],"locales":[],"defaultLocale":"","highlight":false,"markdown":{"tags":{"p":"prose-p","a":"prose-a","blockquote":"prose-blockquote","code-inline":"prose-code-inline","code":"prose-code","em":"prose-em","h1":"prose-h1","h2":"prose-h2","h3":"prose-h3","h4":"prose-h4","h5":"prose-h5","h6":"prose-h6","hr":"prose-hr","img":"prose-img","ul":"prose-ul","ol":"prose-ol","li":"prose-li","strong":"prose-strong","table":"prose-table","thead":"prose-thead","tbody":"prose-tbody","td":"prose-td","th":"prose-th","tr":"prose-tr"},"anchorLinks":{"depth":4,"exclude":[1]},"remarkPlugins":{},"rehypePlugins":{}},"yaml":{},"csv":{"delimeter":",","json":true},"navigation":{"fields":[]},"documentDriven":false,"experimental":{"clientDB":false,"stripQueryParameters":false}}};
...
const _assets = {
  ["nitro:bundled:cache:content:content-index.json"]: {
    ...
    meta: {"type":"application/json","etag":"\"55-tGAg5Zhes0Dhbqq//fawdhbMXVM\"","mtime":"2023-02-26T11:18:17.596Z"}
  },
  ["nitro:bundled:cache:content:content-navigation.json"]: {
    import: () => import('./raw/content-navigation.mjs').then(r => r.default || r),
    meta: {"type":"application/json","etag":"\"8c-vzqQSfUcQBSu5bYtoPM9JaYnbpI\"","mtime":"2023-02-26T11:18:17.596Z"}
  },
  ["nitro:bundled:cache:content:parsed:content:blog:default.md"]: {
    import: () => import('./raw/default.mjs').then(r => r.default || r),
    meta: {"type":"text/markdown; charset=utf-8","etag":"\"a10-PI7k4HFAnHI7UaWPMsVog93lquk\"","mtime":"2023-02-26T11:18:17.596Z"}
  },
  ["nitro:bundled:cache:content:parsed:content:blog:fetch.md"]: {
    import: () => import('./raw/fetch.mjs').then(r => r.default || r),
    meta: {"type":"text/markdown; charset=utf-8","etag":"\"5b4-YW/REfjFCsEbQ+R0GgT5pdPT/ZQ\"","mtime":"2023-02-26T11:18:17.596Z"}
  }
};
...
const _84BVEo = defineEventHandler(async (event) => {
...
const _1AOpPO = defineEventHandler(async (event) => {
...
const _ZlbviB = defineEventHandler(async (event) => {
...
const _PplwxG = defineEventHandler(async (event) => {
  const query = getContentQuery(event);
...
const _lazy_DnBAND = () => import('./manageJob.mjs');
const _lazy_By4XQT = () => import('./job.mjs');
const _lazy_V8iTr1 = () => import('./countJobs.mjs');
const _lazy_7Jbpmc = () => import('./manageApplication.mjs');
const _lazy_UJ9dKs = () => import('./application.mjs');
const _lazy_CjY4p0 = () => import('./renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/job/manageJob', handler: _lazy_DnBAND, lazy: true, middleware: false, method: undefined },
  { route: '/api/job/job', handler: _lazy_By4XQT, lazy: true, middleware: false, method: undefined },
  { route: '/api/job/countJobs', handler: _lazy_V8iTr1, lazy: true, middleware: false, method: undefined },
  { route: '/api/application/manageApplication', handler: _lazy_7Jbpmc, lazy: true, middleware: false, method: undefined },
  { route: '/api/application/application', handler: _lazy_UJ9dKs, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_CjY4p0, lazy: true, middleware: false, method: undefined },
  { route: '/api/_supabase/session', handler: _84BVEo, lazy: false, middleware: false, method: undefined },
  { route: '/api/_content/query/:qid/**:params', handler: _1AOpPO, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query/:qid', handler: _1AOpPO, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _1AOpPO, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.1677410287305.json', handler: _ZlbviB, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _PplwxG, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _PplwxG, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _PplwxG, lazy: false, middleware: false, method: "get" },
  { route: '/**', handler: _lazy_CjY4p0, lazy: true, middleware: false, method: undefined }
];
