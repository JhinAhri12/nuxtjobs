...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><h1 data-v-f4a793fc><b data-v-f4a793fc>Le site de r\xE9f\xE9rence pour trouver ton job sur Nuxt</b></h1><button class="rounded" data-v-f4a793fc>Je me lance </button><div class="grid grid-cols-3 gap-4" data-v-f4a793fc><div class="col-span-2" data-v-f4a793fc>`);
      _push(ssrRenderComponent(_component_JobList, null, null, _parent));
      _push(`</div><div data-v-f4a793fc>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f4a793fc"]]);

export { index as default };
//# sourceMappingURL=index-f2a8bd4d.mjs.map
